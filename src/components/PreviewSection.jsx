...
const PreviewSection = () => {
  const acServicesData = [
    {
      ...
      description:
        "Expert installation for peak AC performance with a free consultation.",
      price: "₹1,199+",
    },
    {
      image:
      ...
      title: "AC Gas topup ",
      description:
        "Swift gas filling to restore your AC’s cooling with guaranteed satisfaction.",
      price: "₹1500+",
    },
    {
      image:
      ...
      description:
        "Comprehensive maintenance to boost efficiency and extend AC lifespan.",
      price: "₹399+",
    },
    {
      image:
  ...
  const roServicesData = [
    {
      image:
        "https://res.cloudinary.com/urbanclap/image/upload/t_high_res_template,q_auto:low,f_auto/w_128,dpr_2,fl_progressive:steep,q_auto:low,f_auto,c_limit/images/growth/home-screen/1733136610539-3f3e73.jpeg",
    ...
    {
      image:
        "https://res.cloudinary.com/urbanclap/image/upload/t_high_res_template,q_auto:low,f_auto/w_128,dpr_2,fl_progressive:steep,q_auto:low,f_auto,c_limit/images/growth/home-screen/1733136605585-3c4829.jpeg",
    ...
    {
      image:
        "https://res.cloudinary.com/urbanclap/image/upload/t_high_res_template,q_auto:low,f_auto/w_128,dpr_2,fl_progressive:steep,q_auto:low,f_auto,c_limit/images/growth/home-screen/1733136615222-84e50b.jpeg",
      title: "Water Purifier Installation",
      description:
        "Professional installation of water purifiers ensuring clean and safe drinking water.",
      price: "₹399",
    },
    {
      image:
        "https://res.cloudinary.com/urbanclap/image/upload/t_high_res_template,q_auto:low,f_auto/w_128,dpr_2,fl_progressive:steep,q_auto:low,f_auto,c_limit/images/growth/home-screen/1733136608298-9f1a6d.jpeg",
      title: "Water Purifier Uninstallation",
      description:
        "Hassle-free uninstallation service for water purifiers with care and safety.",
      price: "₹300",
    },
  ];
      ...
      <section className="py-12 bg-gradient-to-b from-blue-50 to-gray-100">
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          <p className="text-base text-gray-700 mb-8 text-center max-w-2xl mx-auto">
            Discover expert AC solutions for ultimate comfort in Pune, Delhi,
            and Mumbai.
          </p>
