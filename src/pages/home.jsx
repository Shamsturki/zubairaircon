...
const Carousel = () => {
  ...
  const services = [
    {
      ...
      description:
        "Professional installation of all types of AC units, ensuring optimal performance and longevity.",
    },
    {
      image:
        "https://www.shutterstock.com/image-photo/repairman-fix-air-conditioning-systems-600nw-2463365013.jpg",
      title: "AC Repair",
      description:
        "Fast and reliable repair services to fix any AC issues, from leaks to poor cooling.",
    },
    {
      image:
        "https://www.shutterstock.com/image-photo/experienced-hvac-technician-performing-maintenance-600nw-2485364943.jpg",
      title: "AC Maintenance",
      description:
        "Regular maintenance plans to keep your AC running efficiently and prevent breakdowns.",
    },
    {
      image:
        "https://content.jdmagicbox.com/comp/def_content/ac-repair-and-services-videocon/shutterstock-273874790-ac-repair-and-services-videocon-7-ne3ni.jpg",
      title: "Emergency Services",
      description:
        "24/7 emergency support for urgent AC repairs, ensuring you stay cool any time.",
    },
    {
      image:
        "https://www.shutterstock.com/image-photo/hvac-technician-performing-air-conditioner-600nw-2488702851.jpg",
  ...
  return (
    <div className="relative">
      ...
      <button
        onClick={prevSlide}
        className="carousel-button absolute top-1/2 left-4 transform -translate-y-1/2 bg-blue-600 text-white p-3 rounded-full"
      >
        <svg
          className="w-8 h-8"
          fill="none"
      ...
      <button
        onClick={nextSlide}
        className="carousel-button absolute top-1/2 right-4 transform -translate-y-1/2 bg-blue-600 text-white p-3 rounded-full"
      >
        <svg
          className="w-8 h-8"
          fill="none"
...
const FAQItem = ({ question, answer, isOpen, onToggle, isLast }) => (
  <div className={`mb-2 ${!isLast ? "border-b border-gray-300" : ""}`}>
    <button
      className="w-full flex justify-between items-center py-4 text-left focus:outline-none scale-hover"
      onClick={onToggle}
    >
      <h3 className="text-xl font-bold text-gray-900">{question}</h3>
      <svg
        className={`w-6 h-6 chevron text-gray-600 ${
          isOpen ? "rotate-180" : ""
        }`}
        fill="none"
        stroke="currentColor"
  ...
  const faqData = [
    {
      ...
      answer:
        "We recommend servicing your AC unit at least once a year, ideally before the summer season. Regular maintenance ensures optimal performance, prevents breakdowns, and extends the lifespan of your unit.",
    },
    {
      question: "What does AC maintenance include?",
      answer:
        "AC maintenance typically includes cleaning or replacing filters, checking refrigerant levels, inspecting electrical components, cleaning the coils, and ensuring proper airflow. This keeps your AC running efficiently.",
    },
    {
      question: "How do I know if my AC needs repairs?",
      answer:
        "Signs your AC needs repairs include poor cooling, unusual noises, frequent cycling, water leaks, or a sudden increase in energy bills. Contact us immediately if you notice any of these issues.",
    },
    {
      question: "What is the best location for installing an AC unit?",
      answer:
        "The best location depends on your room layout. For split ACs, the indoor unit should be mounted on a wall with good airflow, away from heat sources. Outdoor units need a shaded, well-ventilated spot.",
    },
    {
      question: "Can I install an AC unit myself?",
      answer:
        "We strongly advise against DIY AC installation. Improper installation can lead to inefficiency, leaks, or damage. Our professional technicians ensure safe and correct fitting for optimal performance.",
    },
    {
      question: "How long does AC installation take?",
      answer:
        "A standard AC installation typically takes 3-6 hours, depending on the type of unit and complexity of the setup. Our team works efficiently to minimize disruption.",
    },
    {
      question: "What size AC is right for my room?",
      answer:
        "The right AC size depends on your room’s dimensions, insulation, and usage. A general rule is 1 ton of cooling capacity for every 120-150 square feet. We offer free consultations to help you choose.",
    },
    {
      question: "How can I improve my AC’s efficiency?",
      answer:
        "To improve efficiency, keep filters clean, ensure proper insulation, avoid setting the thermostat too low, and schedule regular maintenance. Also, use curtains to block heat during peak hours.",
    },
    {
      question: "What should I do if my AC is leaking water?",
      answer:
        "Water leaks are often caused by a clogged drain line or low refrigerant. Turn off your AC and contact us immediately. Our technicians will diagnose and fix the issue to prevent further damage.",
    },
    {
      question: "Do you offer emergency AC repair services?",
      answer:
        "Yes, we provide 24/7 emergency repair services. Whether it’s a sudden breakdown or a major issue, our team is ready to help you stay cool and comfortable any time of day.",
    },
  ];
    ...
    <div className="bg-gray-200 py-16 fade-in">
      <div className="w-full lg:w-[60%] mx-auto px-4">
        ...
        <p className="text-lg text-gray-700 mb-8 text-center font-medium">
          At ZubairAircon, we’re here to answer all your questions about AC
          maintenance, installation, and proper usage. Here’s what you need to
          know:
        </p>
        ...
        <p className="text-lg text-gray-700 mt-8 text-center font-medium">
          ZubairAircon is committed to keeping your home or office comfortable
          with expert AC maintenance and fitting services. Contact us today for
          more information!
        </p>
      </div>
    </div>
...
const Home = () => {
  ...
  const slides = [
    {
      image:
        "https://www.hindustantimes.com/ht-img/img/2023/09/13/1600x900/AC_price_1694610505075_1694610521911.jpg",
    },
    { image: "https://www.daikinindia.com/sites/default/files/diakin.jpg" },
    {
      image:
        "https://www.globalheatingairconditioning.com/wp-content/uploads/2023/08/Untitled-design-24.png",
    },
  ];
  ...
  color: transparent;
      ...
      <section className="hero-slideshow max-h-[80vh] pt-18 ">
        ...
        <div className="hero-content container mx-auto px-4">
          <h1 className="text-4xl md:text-6xl font-extrabold mb-4 hero-text gradient-text">
            Beat the Heat with ZubairAircon!
          </h1>
          ...
          <p className="text-lg md:text-2xl mb-8 hero-text text-gray-200 max-w-3xl mx-auto">
            Experience unmatched cooling comfort with our expert AC fitting,
            maintenance, and repair services. Stay cool, all year round, with
            ZubairAircon – your trusted partner in air conditioning excellence.
          </p>
          <Link
            to="/roservices"
            className="hero-button bg-blue-600 text-white font-semibold py-4 px-10 rounded-lg shadow-lg hero-text"
          >
            Get Started Today!
          </Link>
        </div>
      ...
      <section className="expertise-bg py-20 relative text-white">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <h2 className="text-4xl md:text-5xl font-extrabold mb-6 text-center gradient-text">
            Our Expertise in AC Solutions
          </h2>
          <p className="text-lg md:text-xl mb-16 max-w-3xl mx-auto text-center text-gray-200">
            Over a decade of excellence in delivering top-tier AC services
            across Pune, Delhi, and Mumbai.
          </p>
          <div className="flex flex-col md:flex-row justify-center items-center gap-12 mb-16">
            <div className="expertise-card bg-white bg-opacity-10 backdrop-blur-lg rounded-xl p-8 text-center w-full md:w-1/3 shadow-lg">
              ...
              <p className="text-gray-200 mb-6">
                From installation to emergency repairs, we provide end-to-end
                solutions for all AC types.
              </p>
              <svg
            ...
            <div className="expertise-card bg-white bg-opacity-10 backdrop-blur-lg rounded-xl p-8 text-center w-full md:w-1/3 shadow-lg">
              ...
              <p className="text-gray-200 mb-6">
                We use cutting-edge tools and techniques to ensure your AC
      ...
      <section className="bg-gray-200 py-24 min-h-[40vh] text-gray-900 flex items-center">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl md:text-5xl font-extrabold mb-12 text-center gradient-text-dark">
            Our Commitment to Excellence
          </h2>
          <p className="text-lg md:text-xl mb-16 max-w-3xl mx-auto text-center">
            At ZubairAircon, we are dedicated to providing exceptional service,
            sustainability, and customer satisfaction.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="commitment-card bg-white bg-opacity-90 rounded-lg p-6 text-center shadow-lg">
              <svg
                className="commitment-icon w-12 h-12 mx-auto mb-4 text-blue-600"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
                xmlns="http://www.w3.org/2000/svg"
              ...
              <p className="text-gray-700">
                We deliver top-notch AC services with a focus on precision and
                durability, ensuring your unit lasts longer.
              </p>
            </div>
            <div className="commitment-card bg-white bg-opacity-90 rounded-lg p-6 text-center shadow-lg">
              <svg
              ...
              <p className="text-gray-700">
                Your comfort is our priority. We go the extra mile to ensure
                every customer is delighted with our service.
              </p>
            </div>
            <div className="commitment-card bg-white bg-opacity-90 rounded-lg p-6 text-center shadow-lg">
              <svg
              ...
              <p className="text-gray-700">
                We adopt sustainable methods to minimize environmental impact
                while keeping your AC efficient.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="stay-cool-bg h-[70vh] flex items-center justify-center text-center text-white">
        <div className="container mx-auto px-4 my-48">
          <h1 className="text-4xl md:text-6xl font-extrabold mb-4 hero-text gradient-text">
            Stay Cool with ZubairAircon
          </h1>
          <p className="text-lg md:text-2xl mb-8 hero-text text-gray-200 max-w-3xl mx-auto">
            Expert AC fitting, maintenance, and repair services in Pune, Delhi,
            and Mumbai. ZubairAircon delivers cool comfort solutions, all year
            round.
          </p>
          <div className="flex justify-center gap-4">
            <Link
              to="/services"
              className="hero-button bg-blue-600 text-white font-semibold py-3 px-8 rounded-lg shadow-lg hero-text"
            >
              Book a Service Now
            </Link>
            <Link
              to="/services"
              className="hero-button bg-transparent border border-white text-white font-semibold py-3 px-8 rounded-lg shadow-lg hero-text hover:bg-blue-600 hover:border-transparent"
            >
      ...
      <section className="bg-white py-24 min-h-[60vh] text-white flex items-center">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl md:text-5xl font-extrabold mb-12 text-center gradient-text-dark">
            Why Choose ZubairAircon?
          </h2>
          <p className="text-lg md:text-xl mb-16 max-w-3xl mx-auto text-center text-gray-900">
            With years of expertise and a commitment to excellence, ZubairAircon
            stands out as your trusted partner for all AC needs.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="reason-card bg-white bg-opacity-90 rounded-lg p-6 text-center shadow-lg">
              <svg
                className="reason-icon w-12 h-12 mx-auto mb-4 text-blue-600"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
                xmlns="http://www.w3.org/2000/svg"
              ...
              <p className="text-gray-700">
                We pride ourselves on quick response times and dependable
                solutions, ensuring your AC issues are resolved promptly.
              </p>
            </div>
            <div className="reason-card bg-white bg-opacity-90 rounded-lg p-6 text-center shadow-lg">
              <svg
              ...
              <p className="text-gray-700">
                Our certified technicians bring years of experience, ensuring
                top-quality service for every AC unit.
              </p>
            </div>
            <div className="reason-card bg-white bg-opacity-90 rounded-lg p-6 text-center shadow-lg">
              <svg
              ...
              <p className="text-gray-700">
                ...
                making AC care accessible for everyone.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center gap-8">
            ...
            <div className="md:w-1/2 about-text">
              <h2 className="text-4xl md:text-5xl font-extrabold mb-4 gradient-text-dark">
                About ZubairAircon
              </h2>
              <p className="text-lg text-gray-900 mb-4">
                Since 2015, ZubairAircon has been a leading provider of AC
                fitting, maintenance, and repair services across Pune, Delhi,
                and Mumbai. Our mission is to deliver reliable, efficient, and
                affordable solutions to keep your spaces cool and comfortable.
              </p>
              <p className="text-lg text-gray-900 mb-6">
                With a team of skilled technicians and a customer-first
                approach, we ensure every AC unit we service runs at peak
                performance. Trust us to handle all your air conditioning needs
      ...
      <footer className="bg-gray-800 text-gray-300 py-16">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <h3 className="text-2xl font-extrabold text-white mb-4 gradient-text">
                ZubairAircon
              </h3>
              <p className="text-gray-400 mb-4">
                ZubairAircon is your trusted partner for AC fitting,
                maintenance, and repair services. We provide top-notch solutions
                to keep your home or office cool and comfortable year-round.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li>
                  <a href="#home" className="footer-link block text-gray-400">
                    Home
                  </a>
                </li>
                <li>
                  <a
                    href="#services"
                    className="footer-link block text-gray-400"
                  >
                    Services
                  </a>
                </li>
                <li>
                  <a href="#about" className="footer-link block text-gray-400">
                    About Us
                  </a>
                </li>
                <li>
                ...
                <li>
                  <a href="#faq" className="footer-link block text-gray-400">
                    FAQs
                  </a>
                </li>
              </ul>
          ...
          <div className="mt-12 pt-8 border-t border-gray-700 text-center">
            <p className="text-gray-400">
              © 2025 ZubairAircon. All rights reserved.
            </p>
            <p className="text-gray-400 mt-2">
              Coded at night under caffeinne by @Wasi
            </p>
          </div>
        </div>
      </footer>
